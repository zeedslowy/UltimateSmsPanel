...
@section('content')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">{{language_data('Price Bundles')}}</h2>
        </div>
                                ...
                                <table class="table task-items">
                                    ...
                                    @if(count($bundles)>0)
                                        ...
                                        @foreach($bundles as $tr)
                                            ...
                                            <tr class="item-row">
                                                <td><input type="text" name="unit_from[]" class="form-control description salary_from" value="{{$tr->unit_from}}"></td>
                                                <td><input type="text" name="unit_to[]" class="form-control description" value="{{$tr->unit_to}}"></td>
                                                <td><input type="text" name="price[]" class="form-control description" value="{{$tr->price}}"></td>
                                                <td><input type="text" name="trans_fee[]" class="form-control description" value="{{$tr->trans_fee}}"></td>
