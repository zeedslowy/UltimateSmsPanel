                            ...
                            <form class="" role="form" method="post" action="{{url('sms/post-manage-plan-feature')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" name="show_in_client">
                                        <option value="Active" @if($plan_feature->status=='Active') selected @endif>Yes</option>
                                        <option value="Inactive"  @if($plan_feature->status=='Inactive') selected @endif>No</option>
                                    </select>
                                </div>
