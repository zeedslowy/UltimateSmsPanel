                            ...
                            <form class="" role="form" method="post" action="{{url('user/sms/post-bulk-sms')}}">
                                ...
                                @if(app_config('sender_id_verification') == 1)
                                    ...
                                    @else
                                        <div class="form-group">
                                            <label>{{language_data('Sender ID')}}</label>
                                            <p><a href="{{url('user/sms/sender-id-management')}}" class="text-uppercase">{{language_data('Request New Sender ID')}}</a> </p>
                                        </div>
                                    @endif
                                @else
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="help text-uppercase pull-right">{{language_data('Total Number Of Recipients')}}: <span class="number_of_recipients bold text-success m-r-5">0</span></span>
                                </div>
