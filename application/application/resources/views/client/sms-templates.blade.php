...
@section('content')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30 clearfix">
            ...
            <a href="{{url('user/sms/create-sms-template')}}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> {{language_data('Create Template')}}</a>
        </div>
                                ...
                                @foreach($sms_templates as $st)
                                    <tr>
                                        ...
                                        <td data-label="Actions">
                                            @if($st->cl_id!=0)
                                            <a class="btn btn-success btn-xs" href="{{url('user/sms/manage-sms-template/'.$st->id)}}" ><i class="fa fa-edit"></i> {{language_data('Manage')}}</a>
