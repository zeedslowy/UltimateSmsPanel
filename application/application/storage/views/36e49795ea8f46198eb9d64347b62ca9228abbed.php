            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="panel panel-30">
                    ...
                    <div class="panel-body">
                        <form class="" role="form" method="post" action="<?php echo e(url('client/get-login')); ?>">
                            ...
                            <?php if(app_config('captcha_in_client')=='1'): ?>
                ...
                <div class="panel-other-acction">
                    <div class="text-sm text-center">
                        ...
                        <?php if(app_config('client_registration')=='1'): ?>
                            <br><?php echo e(language_data('Need Account')); ?>? <?php echo e(language_data('Sign up')); ?> <a href="<?php echo e(url('signup')); ?>"><?php echo e(language_data('here')); ?></a>
                        <?php endif; ?>
