                ...
                <div class="col-lg-12">
                    ...
                    <div class="tab-content panel p-20">
                        <div role="tabpanel" class="tab-pane active" id="edit-profile">
                            <form role="form" action="<?php echo e(url('user/update-user-post')); ?>" method="post">
                            ...
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="<?php echo e(url('user/tickets/view-ticket/'.$in->id)); ?>" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo e(language_data('View')); ?></a>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(url('user/invoices/edit/'.$in->id)); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> <?php echo e(language_data('Edit')); ?></a>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal fade modal_send_sms_<?php echo e($client->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-some-up form-block" role="form" action="<?php echo e(url('user/send-sms')); ?>" method="post">
    ...
    <div class="modal fade modal_update_limit_<?php echo e($client->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-some-up form-block" role="form" action="<?php echo e(url('user/update-limit')); ?>" method="post">
    ...
    <div class="modal fade modal_change_image_<?php echo e($client->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-some-up form-block" role="form" action="<?php echo e(url('user/update-image')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group input-group-file">
                                        <span class="input-group-btn">
                                            <span class="btn btn-primary btn-file">
                                                <?php echo e(language_data('Browse')); ?> <input type="file" class="form-control" name="client_image" accept="image/*">
                                            </span>
                                        </span>
