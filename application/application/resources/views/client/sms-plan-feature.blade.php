                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body p-none">
                            <table class="table table-ultra-responsive">
                                ...
                                <tr>
                                    <td></td>
                                    <td><button class="btn btn-success center-block" data-toggle="modal" data-target="#purchase_now"><i class="fa fa-shopping-cart"></i> {{language_data('Purchase Now')}}</button> </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">{{language_data('Purchase SMS Plan')}}</h4>
                        </div>
