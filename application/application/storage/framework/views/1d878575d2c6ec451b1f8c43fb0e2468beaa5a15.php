                                ...
                                <?php $__currentLoopData = $clientGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(url('user/view-contact/'.$cg->id)); ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> <?php echo e(language_data('View Contacts')); ?></a>
                                            <a href="<?php echo e(url('user/add-contact/'.$cg->id)); ?>" class="btn btn-complete btn-xs"><i class="fa fa-plus"></i> <?php echo e(language_data('Add Contact')); ?></a>
