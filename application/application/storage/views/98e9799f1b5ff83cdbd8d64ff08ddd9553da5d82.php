...
<?php $__env->startSection('content'); ?>
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title"><?php echo e(language_data('Clients Groups')); ?></h2>
        </div>
        <div class="p-30 p-t-none p-b-none">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="<?php echo e(url('users/add-new-group')); ?>">
                ...
                <div class="col-lg-8">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo e(language_data('Clients Groups')); ?></h3>
                        </div>
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 30%;"><?php echo e(language_data('Group Name')); ?></th>
                                ...
                                <?php $__currentLoopData = $clientGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td data-label="Actions">
                                            <a href="<?php echo e(url('users/export-user-group/'.$cg->id)); ?>" class="btn btn-complete btn-xs"><i class="fa fa-upload"></i> <?php echo e(language_data('Export Clients')); ?></a>
                                            ...
                                            <?php echo $__env->make('client.modal-edit-client-group', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
