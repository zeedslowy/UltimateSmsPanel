...
class ContactController extends Controller
{
    ...
    public function addContact($id)
    {
        ...
        if ($exist){
            ...
            return view('admin.add-contact', compact('contact_list', 'id'));
        }else{
            return redirect('sms/phone-book')->with([
    ...
    public function importContacts(){
        ...
        return view('admin.import-contact',compact('phone_book'));
    ...
    {
        $contact_list = ContactList::select(['id', 'phone_number', 'first_name', 'email_address', 'user_name', 'company'])->where('pid',$id);
