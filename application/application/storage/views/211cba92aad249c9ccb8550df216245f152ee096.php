                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <a href="<?php echo e(url('user/sms/download-sample-sms-file')); ?>" class="btn btn-complete"><i class="fa fa-download"></i> <?php echo e(language_data('Download Sample File')); ?></a>
                                </div>
                            </div>
                            ...
                            <div id="send-sms-file-wrapper">
                                ...
                                <form id="send-sms-file-form" class="" role="form" method="post" action="<?php echo e(url('user/sms/post-sms-from-file')); ?>" enctype="multipart/form-data">
