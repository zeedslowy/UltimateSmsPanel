                                ...
                                @foreach($features as $f)
                                    <tr>
                                        ...
                                        <td data-label="Actions">
                                            <a class="btn btn-complete btn-xs" href="{{url('sms/manage-plan-feature/'.$f->id)}}" ><i class="fa fa-edit"></i> {{language_data('Manage')}}</a>
                                            <a href="#" class="btn btn-danger btn-xs cdelete" id="{{$f->id}}"><i class="fa fa-trash"></i> {{language_data('Delete')}}</a>
                                        </td>
                                    </tr>
                                @endforeach
