                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 30%;"><?php echo e(language_data('Plan Name')); ?></th>
                                    ...
                                    <th style="width: 35%;"><?php echo e(language_data('Action')); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php $__currentLoopData = $price_plan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td data-label="Actions">
                                            <a class="btn btn-success btn-xs" href="<?php echo e(url('sms/add-plan-feature/'.$pp->id)); ?>" ><i class="fa fa-plus"></i> <?php echo e(language_data('Add Feature')); ?></a>
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(url('sms/view-plan-feature/'.$pp->id)); ?>" ><i class="fa fa-eye"></i> <?php echo e(language_data('View Features')); ?></a>
                                            <a class="btn btn-complete btn-xs" href="<?php echo e(url('sms/manage-price-plan/'.$pp->id)); ?>" ><i class="fa fa-edit"></i> <?php echo e(language_data('Manage')); ?></a>
                                            <a href="#" class="btn btn-danger btn-xs cdelete" id="<?php echo e($pp->id); ?>"><i class="fa fa-trash"></i> <?php echo e(language_data('Delete')); ?></a>
                                        </td>
                                    </tr>
