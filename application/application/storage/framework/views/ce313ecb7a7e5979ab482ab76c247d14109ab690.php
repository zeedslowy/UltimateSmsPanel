                                ...
                                <div class="col-lg-6 p-t-20">
                                    ...
                                    <div class="btn-group pull-right" aria-label="...">
                                        ...
                                        <?php if($inv->status=='Unpaid' || $inv->status=='Partially Paid'): ?>
                                            <a href="#" data-toggle="modal" data-target="#pay-invoice" class="btn btn-success  btn-sm pay-invoice"><i class="fa fa-check"></i> <?php echo e(language_data('Pay')); ?></a>
                                        <?php endif; ?>

                                        <a href="<?php echo e(url('user/invoices/client-iview/'.$inv->id)); ?>" target="_blank" class="btn btn-danger  btn-sm"><i class="fa fa-paper-plane-o"></i> <?php echo e(language_data('Preview')); ?></a>

                                        <a href="<?php echo e(url('user/invoices/download-pdf/'.$inv->id)); ?>" class="btn btn-pdf  btn-sm download-pdf"><i class="fa fa-file-pdf-o"></i> <?php echo e(language_data('PDF')); ?></a>
                                        <a href="<?php echo e(url('user/invoices/iprint/'.$inv->id)); ?>" target="_blank" class="btn btn-primary  btn-sm"><i class="fa fa-print"></i> <?php echo e(language_data('Print')); ?></a>
                                        <br>
                                        <br>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" id="myModalLabel"><?php echo e(language_data('Pay Invoice')); ?></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <form class="form-some-up" role="form" action="<?php echo e(url('user/invoices/pay-invoice')); ?>" method="post">
                                                            ...
                                                            <div class="text-right">
                                                                ...
                                                                <button type="submit" class="btn btn-success btn-sm"><?php echo e(language_data('Pay')); ?></button>
                                                            </div>
                                                        </form>
