                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <table class="table table-hover" id="invoice_items">
                                            ...
                                            <tr class="info">
                                                <td><input type="text" class="form-control item_name" required name="desc[]" value="{{$it->item}}"></td>
                                                <td><input type="text" class="form-control item_price" required name="amount[]" value="{{$it->price}}"></td>
                                                <td><input type="text" class="form-control qty" required value="{{$it->qty}}" name="qty[]"></td>
