                                ...
                                @foreach($clientGroups as $cg)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('user/view-contact/'.$cg->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> {{language_data('View Contacts')}}</a>
                                            <a href="{{url('user/add-contact/'.$cg->id)}}" class="btn btn-complete btn-xs"><i class="fa fa-plus"></i> {{language_data('Add Contact')}}</a>
