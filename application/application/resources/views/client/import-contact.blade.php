                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <a href="{{url('user/sms/download-contact-sample-file')}}" class="btn btn-complete"><i class="fa fa-download"></i> {{language_data('Download Sample File')}}</a>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="{{url('user/post-multiple-contact')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="help">{{language_data('Insert number with comma')}} (,) Ex. 8801670000000,8801721000000</span>
                                </div>
