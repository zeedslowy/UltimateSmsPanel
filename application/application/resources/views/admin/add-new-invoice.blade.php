                            ...
                            <form method="post" action="{{url('invoices/post-new-invoice')}}">
                                ...
                                <div class="col-lg-8">
                                    <table class="table table-hover" id="invoice_items">
                                        ...
                                        <tbody>
                                        <tr class="info">
                                            <td><input type="text" class="form-control item_name"  required name="desc[]" value=""></td>
                                            <td><input type="text" class="form-control item_price" required name="amount[]" value=""></td>
                                            <td><input type="text" class="form-control qty" required value="" name="qty[]"></td>
