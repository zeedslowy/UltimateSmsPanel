...
@section('content')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">{{language_data('Buy Unit')}}</h2>
        </div>
        <div class="p-30 p-t-none p-b-none">
            ...
            <div class="row">
                        ...
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="{{url('users/post-buy-unit')}}">
                                ...
                                <button type="submit" class="btn btn-success btn-sm pull-right purchase_button"><i
                                            class="fa fa-plus"></i> {{language_data('Purchase Now')}} </button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{{language_data('Price Bundles')}}</h3>
                        </div>
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                <thead>
                                <tr>
                                    <th style="width: 60%;">{{language_data('Number of Units')}}</th>
                                    <th style="width: 40%;">{{language_data('Price Per Unit')}}</th>
                                </tr>
                                </thead>
                                <tbody>
