            ...
            <div class="row">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <a href="<?php echo e(url('user/sms/download-contact-sample-file')); ?>" class="btn btn-complete"><i class="fa fa-download"></i> <?php echo e(language_data('Download Sample File')); ?></a>
                                </div>
                            </div>

                            <div id="send-sms-file-wrapper">
                                <form class="" id="send-sms-file-form" role="form" method="post" action="<?php echo e(url('user/post-import-file-contact')); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" v-show="number_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="email_address_column" name="email_address_column"  data-live-search="true" v-model="number_column">
                                            <option v-for="column in number_columns" :value="column.key" v-text="column.value"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" v-show="number_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="user_name_column" name="user_name_column"  data-live-search="true" v-model="number_column">
                                            <option v-for="column in number_columns" :value="column.key" v-text="column.value"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" v-show="number_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="company_column" name="company_column"  data-live-search="true" v-model="number_column">
                                            <option v-for="column in number_columns" :value="column.key" v-text="column.value"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" v-show="number_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="first_name_column" name="first_name_column"  data-live-search="true" v-model="number_column">
                                            <option v-for="column in number_columns" :value="column.key" v-text="column.value"></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" v-show="number_columns.length > 0">
                                        ...
                                        <select class="selectpicker form-control" ref="last_name_column" name="last_name_column"  data-live-search="true" v-model="number_column">
                                            <option v-for="column in number_columns" :value="column.key" v-text="column.value"></option>
                                        </select>
                                    </div>
                ...
                <div class="col-lg-8">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="<?php echo e(url('user/post-multiple-contact')); ?>">

                                <div class="form-group">
                                    <label><?php echo e(language_data('Paste Numbers')); ?></label>
                                    <textarea class="form-control" rows="5" name="import_numbers"></textarea>
                                    <span class="help"><?php echo e(language_data('Insert number with comma')); ?> (,) Ex. 8801670000000,8801721000000</span>
                                </div>
